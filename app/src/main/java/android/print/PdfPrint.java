...
public class PdfPrint {
    ...
    public void print(PrintDocumentAdapter printAdapter, final File path, final String fileName) {
        PrintDocumentAdapter.LayoutResultCallback layoutResultCallbackc = new PrintDocumentAdapter.LayoutResultCallback() {
            @Override
        ...
        printAdapter.onLayout(null, printAttributes, null, layoutResultCallbackc, null);
    }
